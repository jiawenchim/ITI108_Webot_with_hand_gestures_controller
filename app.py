...
TIME_STEP = 16
camera_sensitivity = 500 #will translate to frame per second. lower value means more sensitive (more frames can be inferred per second)
...
def main():    
    ...
    while True:
        ...
        # Process Key (ESC: end) #################################################
        key = cv.waitKey(camera_sensitivity)
        if key == 27:  # ESC
            break
